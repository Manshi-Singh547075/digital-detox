...
const Benefits = () => {
  ...
  return <section className="py-20 bg-gradient-to-r from-blue-50 to-green-50 bg-gray-950">
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <div className="rounded-3xl shadow-2xl p-8 bg-green-100">
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-3">
                      <div className="bg-gradient-to-r from-blue-500 to-green-500 h-3 rounded-full" style={{
                      width: '85%'
                    }}></div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-3">
                      <div className="bg-gradient-to-r from-green-500 to-emerald-500 h-3 rounded-full" style={{
                      width: '92%'
                    }}></div>
                    </div>
                  </div>
