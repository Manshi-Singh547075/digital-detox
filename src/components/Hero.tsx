...
const Hero = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-green-600 text-white min-h-screen">
      ...
      <div className="absolute bottom-40 left-20 w-20 h-20 bg-blue-300/10 rounded-full animate-float" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="relative container mx-auto px-6 py-20 lg:py-32 mt-20">
            ...
            <div className="relative bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20 hover:bg-white/15 transition-all duration-300 hover:scale-105">
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-green-400 to-blue-400 rounded-2xl p-6 text-center transform hover:scale-105 transition-transform duration-300">
                  <div className="flex justify-center mb-4">
                    <div className="relative">
                      <img 
                        src="https://images.unsplash.com/photo-1531297484001-80022131f5a1?w=100&h=80&fit=crop" 
                        alt="Device" 
                        className="w-12 h-12 object-cover rounded-lg opacity-80 animate-float"
                      />
                      <Smartphone className="absolute -top-1 -right-1 w-6 h-6 text-white animate-bounce-slow" />
                    </div>
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    {[
                      { name: 'Social Media', time: '1h 45m', color: 'bg-red-400', width: 'w-3/4' },
                      { name: 'Work Apps', time: '2h 12m', color: 'bg-blue-400', width: 'w-4/5' },
                      { name: 'Entertainment', time: '26m', color: 'bg-green-400', width: 'w-1/3' }
                    ].map((app, index) => (
                      <div key={app.name} className="flex items-center justify-between animate-fade-in" style={{ animationDelay: `${0.8 + index * 0.2}s` }}>
        ...
        <div className="flex justify-center mt-16 space-x-8 animate-fade-in" style={{ animationDelay: '1s' }}>
          {[
            { icon: Monitor, label: '50k+ Users', delay: '0s' },
            { icon: Shield, label: '99.9% Uptime', delay: '0.2s' },
            { icon: Heart, label: '4.9/5 Rating', delay: '0.4s' }
          ].map((item, index) => (
            <div key={index} className="flex flex-col items-center space-y-2 text-blue-200 animate-fade-in" style={{ animationDelay: item.delay }}>
