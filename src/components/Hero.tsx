      ...
      <div className="relative container mx-auto px-4 sm:px-6 py-16 sm:py-20 lg:py-32 mt-16 sm:mt-20">
          ...
          <div className="space-y-6 sm:space-y-8 animate-fade-in order-2 lg:order-1">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                ...
                className="w-full sm:w-auto bg-white text-blue-700 hover:bg-blue-50 font-semibold px-6 sm:px-8 py-3 rounded-full transition-all duration-300 hover:scale-105 hover:shadow-lg"
              >
                Start Your Journey
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    {[{
                      ...
                      <div key={app.name} className="flex items-center justify-between animate-fade-in" style={{
        ...
        <div className="flex flex-wrap justify-center mt-12 sm:mt-16 gap-4 sm:gap-8 animate-fade-in" style={{
          ...
          {[{
            ...
            <div key={index} className="flex flex-col items-center space-y-1 sm:space-y-2 text-blue-200 animate-fade-in" style={{
